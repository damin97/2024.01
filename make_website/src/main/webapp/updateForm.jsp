	...
	<div class="container" style="padding-top: 50px">
		<form action="memberUpdate.jsp" method="post">
			<div class="mb-3">
				...
				<input type="text" readonly name="memberno" value="<%=memberno%>" class="form-control" id="idInput" placeholder="회원번호">
			</div>
			<div class="mb-3">
			...
			<div class="mb-3">
				...
				<input type="email" name="email" value="<%=email%>" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com">
			</div>
			<div class="mb-3">
